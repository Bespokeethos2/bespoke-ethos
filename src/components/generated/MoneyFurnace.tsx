...
const MoneyFurnace = () => {
  ...
  // Derive calculated values from state
  const annualSavings = useMemo(() => employees * hours * 50 * 52 * 0.3, [employees, hours]);
  const isBurning = useMemo(() => !(employees > 0 && hours > 0), [employees, hours]);
