...
export default function HomePage() {
  return (
    <div aria-label="Bespoke Ethos homepage" className="min-h-screen relative overflow-hidden bg-background selection:bg-orange-500/30">
      ...
      {/* 1. HERO: The Console */}
      <section className="relative z-10 pt-20 pb-12 sm:pt-24 sm:pb-16 md:pt-32 md:pb-24 lg:pt-40 lg:pb-32">
          ...
          <PremiumContainer variant="glass" className="p-1 md:p-2 border-orange-500/20 shadow-2xl shadow-orange-900/10">
            <div className="relative overflow-hidden rounded-xl bg-slate-950/90 aspect-[16/9] md:aspect-[21/9] flex items-center justify-center">
              ...
              <div className="relative z-20 text-center max-w-5xl px-4 animate-fadeIn">
                <div className="inline-flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-1.5 rounded-full border border-orange-500/30 bg-orange-950/40 backdrop-blur-md mb-6 sm:mb-8">
                  <span className="relative flex h-2 w-2">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-orange-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2 w-2 bg-orange-500"></span>
                  </span>
                  <span className="text-[10px] sm:text-xs font-bold text-orange-200 tracking-widest uppercase font-mono">Operations Normal</span>
                </div>
                
                <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black tracking-tight mb-6 sm:mb-8 leading-[0.9]">
                ...
                <p className="text-sm sm:text-base md:text-xl lg:text-2xl text-slate-400 max-w-3xl mx-auto leading-relaxed font-light mb-8 sm:mb-10 px-4 sm:px-0">
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center items-center px-4 sm:px-0">
                  <ButtonLink 
                    intent="primary" 
                    href="/contact" 
                    className="w-full sm:w-auto h-12 sm:h-14 px-8 sm:px-10 text-base sm:text-lg rounded-full shadow-[0_0_25px_rgba(249,115,22,0.3)] hover:shadow-[0_0_40px_rgba(249,115,22,0.5)] transition-all bg-orange-600 hover:bg-orange-500 border-none text-white font-bold tracking-wide"
                  >
                    Start Your Build
                  </ButtonLink>
                  <ButtonLink 
                    intent="secondary" 
                    href="/solutions" 
                    className="w-full sm:w-auto h-12 sm:h-14 px-8 sm:px-10 text-base sm:text-lg rounded-full border-white/10 hover:bg-white/5 backdrop-blur-md text-slate-200"
                  >
                    See The Specs
                  </ButtonLink>
                </div>
                ...
                <nav className="mt-10 sm:mt-12 relative px-4 sm:px-0">
                  {/* Vertical connecting line */}
                  <div className="absolute left-1/2 -top-10 sm:-top-12 w-px h-10 sm:h-12 bg-gradient-to-b from-transparent via-white/30 to-white/50" />
                  <ul className="flex flex-wrap justify-center items-center border border-white/20 rounded-md backdrop-blur-sm bg-white/5 overflow-hidden">
                    <li className="border-r border-white/20 last:border-r-0 flex-shrink-0">
                      <a href="/solutions" className="block px-4 sm:px-6 py-2.5 sm:py-3 text-[10px] sm:text-xs uppercase tracking-[0.2em] text-white/70 hover:text-white hover:bg-white/10 transition-all whitespace-nowrap">
                        Solutions
                      </a>
                    </li>
                    <li className="border-r border-white/20 last:border-r-0 flex-shrink-0">
                      <a href="/pricing" className="block px-4 sm:px-6 py-2.5 sm:py-3 text-[10px] sm:text-xs uppercase tracking-[0.2em] text-white/70 hover:text-white hover:bg-white/10 transition-all whitespace-nowrap">
                        Pricing
                      </a>
                    </li>
                    <li className="border-r border-white/20 last:border-r-0 flex-shrink-0">
                      <a href="/about" className="block px-4 sm:px-6 py-2.5 sm:py-3 text-[10px] sm:text-xs uppercase tracking-[0.2em] text-white/70 hover:text-white hover:bg-white/10 transition-all whitespace-nowrap">
                        About
                      </a>
                    </li>
                    <li className="flex-shrink-0">
                      <a href="/contact" className="block px-4 sm:px-6 py-2.5 sm:py-3 text-[10px] sm:text-xs uppercase tracking-[0.2em] text-orange-400 hover:text-orange-300 hover:bg-white/10 transition-all font-medium whitespace-nowrap">
                        Contact
                      </a>
                    </li>
                  </ul>
      ...
      <section className="relative z-10 py-12 sm:py-16 md:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 max-w-4xl">
           <div className="relative">
             {/* Quote Decor */}
             <div className="absolute -top-8 sm:-top-12 -left-4 sm:-left-8 text-6xl sm:text-8xl md:text-9xl text-white/5 font-serif select-none pointer-events-none">"</div>
             ...
             <div className="space-y-4 sm:space-y-6 text-sm sm:text-base md:text-lg lg:text-xl text-slate-300 leading-relaxed font-light">
               <p>
      ...
      {/* 3. SOCIAL PROOF */}
      <div className="relative z-10 py-10 sm:py-12 md:py-16 border-y border-white/5 bg-slate-950/50 backdrop-blur-sm">
        <p className="text-center text-[10px] sm:text-xs font-bold uppercase tracking-[0.3em] text-slate-600 mb-8 sm:mb-10 px-4">Trusted Operating Systems</p>
        <TestimonialMarquee />
      </div>

      {/* 4. CAPABILITIES: Bento */}
      <section id="capabilities" className="relative z-10 py-16 sm:py-20 md:py-24 lg:py-32 bg-slate-950">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="mb-12 sm:mb-16 md:flex md:items-end md:justify-between gap-8">
            <div className="max-w-2xl">
              <span className="text-orange-500 font-mono text-xs sm:text-sm tracking-tight mb-3 sm:mb-4 block">// SYSTEM CAPABILITIES</span>
            ...
            <p className="mt-6 md:mt-0 text-slate-400 max-w-md text-sm sm:text-base md:border-l-2 border-orange-500/30 md:pl-6 py-2">
      ...
      <section id="pricing-section" className="relative z-10 py-12 sm:py-16 md:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
          <PremiumContainer variant="obsidian" className="p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20 relative overflow-hidden group">
            {/* Background Glow */}
      ...
      <section className="relative z-10 py-12 sm:py-16 md:py-20 lg:py-24 bg-slate-950">
        <div className="container mx-auto px-4 sm:px-6">
           <PremiumContainer variant="glass" className="p-6 sm:p-8 md:p-12 lg:p-16 text-center border-white/5 bg-slate-900/40">
             <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6">
               <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-hero-accent text-white text-glow-crimson">
                 AI Strategy Sprints™
               </h2>
               <div className="text-orange-500 font-mono text-xs sm:text-sm tracking-wide uppercase mb-4">Powered by Consensus Engine</div>
      ...
      <section className="relative z-10 py-12 sm:py-16 md:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
          <div className="text-center mb-12 sm:mb-16">
            <span className="text-orange-500/50 font-mono text-[10px] sm:text-xs tracking-widest mb-3 sm:mb-4 block">01001000 01000101 01001100 01010000</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white font-hero-accent text-glow-crimson">
      ...
      {/* 9. SAFETY NET */}
      <section id="founder" className="relative z-10 py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-t from-orange-950/20 to-slate-950">
        <div className="container relative z-10 mx-auto px-4 sm:px-6 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-10 sm:gap-12 md:gap-16 items-center">
            <div className="space-y-4 sm:space-y-6">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white font-hero-accent leading-tight text-glow-crimson">
                We lift as we climb.
              </h2>
              <div className="h-1 w-20 sm:w-24 bg-orange-500 rounded-full" />
            ...
            <div className="relative aspect-square md:aspect-auto md:h-80 rounded-2xl overflow-hidden border border-white/10 bg-slate-900/50 shadow-2xl flex items-center justify-center p-6 sm:p-8 text-center group">
               ...
               <blockquote className="relative z-10">
                 <p className="text-base sm:text-lg text-slate-200 italic font-light mb-3 sm:mb-4">
                   "Upton helped us automate our entire intake process. We got our weekends back."
                 </p>
                 <footer className="text-[10px] sm:text-xs font-bold text-orange-500/80 uppercase tracking-widest">
                   — Sarah & Jen, Cleveland
                 </footer>
               </blockquote>
            </div>
