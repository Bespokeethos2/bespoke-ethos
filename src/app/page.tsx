  ...
  return (
    <div aria-label="Bespoke Ethos homepage" className="min-h-screen relative overflow-hidden bg-background selection:bg-orange-500/30">
      ...
      <section className="relative z-10 py-20 sm:py-28 md:py-32 bg-slate-950 px-4 sm:px-6">
        <div className="container mx-auto">
          <div className="mb-12 sm:mb-16 md:flex md:items-end md:justify-between md:gap-8">
            ...
            <p className="mt-6 md:mt-0 text-slate-300 max-w-md text-sm sm:text-base border-l-2 border-orange-500/30 pl-4 sm:pl-6 py-2">
        ...
        <div className="container mx-auto">
           <PremiumContainer variant="glass" className="p-6 sm:p-8 md:p-12 lg:p-16 text-center border-white/5 bg-slate-900/40">
             <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6">
               ...
               <div className="text-orange-500 font-mono text-xs sm:text-sm tracking-wide uppercase mb-2 sm:mb-4">Powered by Consensus Engine</div>
               <p className="text-base md:text-lg lg:text-xl text-slate-200 leading-relaxed font-light">
