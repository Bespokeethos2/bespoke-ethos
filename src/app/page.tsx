...
export default function HomePage() {
  return (
    <div aria-label="Bespoke Ethos homepage" className="min-h-screen relative overflow-hidden bg-background selection:bg-orange-500/30">
      ...
      {/* 1. HERO: The Console */}
      <section className="relative z-10 pt-24 pb-16 md:pt-32 md:pb-24 px-4 sm:px-6">
        <div className="container mx-auto">
          <PremiumContainer variant="glass" className="p-2 md:p-3 border-orange-500/20 shadow-2xl shadow-orange-900/10">
            <div className="relative overflow-hidden rounded-xl bg-slate-950/90 aspect-[16/9] md:aspect-[21/9] flex items-center justify-center">
              ...
              <div className="relative z-20 text-center max-w-5xl px-4 sm:px-6 md:px-8 animate-fadeIn">
                ...
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-300 max-w-3xl mx-auto leading-relaxed font-light mb-8 sm:mb-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center items-center">
                  <ButtonLink intent="primary" href="/contact" className="w-full sm:w-auto h-12 sm:h-14 px-8 sm:px-10 text-base sm:text-lg rounded-full shadow-[0_0_25px_rgba(249,115,22,0.3)] hover:shadow-[0_0_40px_rgba(249,115,22,0.5)] transition-all bg-orange-600 hover:bg-orange-500 border-none text-white font-bold tracking-wide">
                    Start Your Build
                  </ButtonLink>
                  <ButtonLink intent="secondary" href="/solutions" className="w-full sm:w-auto h-12 sm:h-14 px-8 sm:px-10 text-base sm:text-lg rounded-full border-white/10 hover:bg-white/5 backdrop-blur-md text-slate-200">
                    See The Specs
                  </ButtonLink>
                </div>
                ...
                <nav className="mt-8 sm:mt-12 relative">
                  ...
                  <div className="absolute left-1/2 -top-8 sm:-top-12 w-px h-8 sm:h-12 bg-gradient-to-b from-transparent via-white/30 to-white/50" />
                  <ul className="flex flex-wrap justify-center items-center border border-white/20 rounded-md backdrop-blur-sm bg-white/5">
                    <li className="border-r border-white/20 last:border-r-0">
                      <a href="/solutions" className="block px-4 sm:px-6 py-2.5 sm:py-3 text-xs uppercase tracking-[0.2em] text-white/80 hover:text-white hover:bg-white/10 transition-all">
                        Solutions
                      </a>
                    </li>
                    <li className="border-r border-white/20 last:border-r-0">
                      <a href="/pricing" className="block px-4 sm:px-6 py-2.5 sm:py-3 text-xs uppercase tracking-[0.2em] text-white/80 hover:text-white hover:bg-white/10 transition-all">
                        Pricing
                      </a>
                    </li>
                    <li className="border-r border-white/20 last:border-r-0">
                      <a href="/about" className="block px-4 sm:px-6 py-2.5 sm:py-3 text-xs uppercase tracking-[0.2em] text-white/80 hover:text-white hover:bg-white/10 transition-all">
                        About
                      </a>
                    </li>
                    <li>
                      <a href="/contact" className="block px-4 sm:px-6 py-2.5 sm:py-3 text-xs uppercase tracking-[0.2em] text-orange-400 hover:text-orange-300 hover:bg-white/10 transition-all font-medium">
                        Contact
                      </a>
                    </li>
                  </ul>
      ...
      <section className="relative z-10 py-16 sm:py-20 md:py-24 px-4 sm:px-6">
        <div className="container mx-auto max-w-4xl">
           <div className="relative">
             ...
             <div className="space-y-4 sm:space-y-6 text-base md:text-lg lg:text-xl text-slate-200 leading-relaxed font-light">
               <p>
      ...
      <section className="relative z-10 py-20 sm:py-28 md:py-32 bg-slate-950 px-4 sm:px-6">
        <div className="container mx-auto">
          <div className="mb-12 sm:mb-16 space-y-4 md:space-y-0 md:flex md:items-end md:justify-between md:gap-8">
            ...
            <p className="text-slate-300 max-w-md text-sm sm:text-base border-l-2 border-orange-500/30 pl-4 sm:pl-6 py-2">
          ...
          <PremiumContainer variant="obsidian" className="p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20 relative overflow-hidden group">
            ...
            <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 relative z-10">
              ...
              <div className="flex flex-col justify-center border-t lg:border-t-0 lg:border-l border-white/10 pt-8 lg:pt-0 lg:pl-12 xl:pl-16">
                 <div className="text-xs sm:text-sm font-medium text-slate-500 uppercase tracking-widest mb-2">Builds Starting At</div>
                 <div className="text-5xl sm:text-6xl md:text-7xl font-black text-white tracking-tight mb-3 sm:mb-4">
                   $1,497
                 </div>
                 <p className="text-sm text-slate-300 mb-6 sm:mb-8 max-w-md">
      ...
      <section className="relative z-10 py-16 sm:py-20 md:py-24 bg-slate-950 px-4 sm:px-6">
        <div className="container mx-auto">
           <PremiumContainer variant="glass" className="p-6 sm:p-8 md:p-12 lg:p-16 text-center border-white/5 bg-slate-900/40">
             <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6">
               ...
               <div className="text-orange-500 font-mono text-xs sm:text-sm tracking-wide uppercase">Powered by Consensus Engine</div>
               <p className="text-base md:text-lg lg:text-xl text-slate-200 leading-relaxed font-light px-4">
      ...
      <section className="relative z-10 py-16 sm:py-20 md:py-24 px-4 sm:px-6">
        <div className="container mx-auto max-w-3xl">
          <div className="text-center mb-12 sm:mb-16">
            <span className="text-orange-500/50 font-mono text-xs tracking-widest mb-3 sm:mb-4 block">01001000 01000101 01001100 01010000</span>
      ...
      {/* 9. SAFETY NET */}
      <section className="relative z-10 py-16 sm:py-20 md:py-24 bg-gradient-to-t from-orange-950/20 to-slate-950 px-4 sm:px-6">
        <div className="container relative z-10 mx-auto max-w-5xl">
          <div className="grid md:grid-cols-2 gap-12 sm:gap-16 items-center">
            ...
            <div className="relative aspect-square md:aspect-auto md:h-72 lg:h-80 rounded-2xl overflow-hidden border border-white/10 bg-slate-900/50 shadow-2xl flex items-center justify-center p-6 sm:p-8 text-center group">
