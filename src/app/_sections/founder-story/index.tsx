...
export function FounderStory() {
  return (
    <section className="bg-surface-secondary dark:bg-dark-surface-secondary py-16 md:py-20 lg:py-24 px-4 sm:px-6">
      <div className="mx-auto max-w-5xl founder-story-wrap">
        <div className="founder-story-portrait relative overflow-hidden rounded-2xl shadow-2xl be-image-frame mb-8 md:mb-10 aspect-[4/3] md:aspect-[16/9]">
          <Image
        ...
        <div className="space-y-5 sm:space-y-6">
          <div>
            <p className="text-xs sm:text-sm font-semibold uppercase tracking-[0.25em] sm:tracking-[0.3em] text-text-tertiary dark:text-dark-text-tertiary">
              Meet the Founder
            </p>
            <h2 className="mt-4 text-balance text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight text-text-primary dark:text-dark-text-primary">
              My First Business Almost Broke Me. AI Saved It.
            </h2>
          </div>

          <div className="founder-story-copy space-y-4 sm:space-y-5 text-text-secondary dark:text-dark-text-secondary leading-relaxed text-base md:text-lg">
            <p>
