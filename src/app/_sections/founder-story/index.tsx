    ...
    <section className="bg-surface-secondary dark:bg-dark-surface-secondary py-16 md:py-20 px-4 sm:px-6">
      <div className="mx-auto max-w-5xl">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
          {/* Image Column */}
          <div className="founder-story-portrait relative overflow-hidden rounded-2xl shadow-2xl border-4 border-orange-500/20 bg-gradient-to-br from-slate-800/50 to-slate-900/80 p-3">
            <div className="relative w-full max-w-[400px] aspect-[3/4] rounded-xl overflow-hidden ring-2 ring-white/10 mx-auto">
              <Image
          ...
          <div className="space-y-6 sm:space-y-7">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.25em] sm:tracking-[0.3em] text-orange-500 mb-3">
                Meet the Founder
              </p>
