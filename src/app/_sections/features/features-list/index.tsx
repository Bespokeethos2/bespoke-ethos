...
export interface FeatureCardItem {
  ...
  characteristics: { items: { title: string }[] };
}

export interface FeaturesListHeading {
  title: string;
  subtitle?: string;
  tag?: string | null;
}
...
export interface FeaturesListProps {
  heading: FeaturesListHeading;
  featuresCardsList: { items: FeatureCardItem[] };
}

export async function FeaturesList({ featuresCardsList, heading }: FeaturesListProps) {
  return (
