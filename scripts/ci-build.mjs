...
env.NEXT_TURBOPACK_ROOT = workspaceRoot;
env.NEXT_TURBOPACK = '0';
env.NEXT_PRIVATE_TURBOPACK = '0';
if (!env.NEXT_TURBOPACK) env.NEXT_TURBOPACK = '0';
if (!env.NEXT_PRIVATE_TURBOPACK) env.NEXT_PRIVATE_TURBOPACK = '0';
