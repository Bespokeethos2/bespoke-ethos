...
function createSvg(filename, title, subtitle = "Bespoke Ethos") {
...
const assets = [
    ...
    "badge_nglcc.svg",
    "badge_catalant.svg",
    "badge_experience.svg",
    "cadence_infographic.svg",
    "cadence_demo_interaction.svg",
    "consensus_interface.svg",
    "hero_consensus_desktop.svg"
];

assets.forEach(asset => {
    const title = asset.replace(/-/g, " ").replace(".svg", "").replace(/_/g, " ").replace(/\b\w/g, c => c.toUpperCase());
    createSvg(asset, title);
});
