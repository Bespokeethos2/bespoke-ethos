...
export function ConversionOptimizedHero() {
  return (
    <section className="relative overflow-hidden bg-[#1a1a2e] py-16 sm:py-24 lg:py-32">
      {/* Cinematic Ambient Lighting - Dark mode with warm accents */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-20%] left-[10%] h-[800px] w-[800px] rounded-full bg-[radial-gradient(circle_at_center,rgba(233,69,96,0.15),transparent_70%)]" />
        <div className="absolute bottom-[-10%] right-[-5%] h-[700px] w-[700px] rounded-full bg-[radial-gradient(circle_at_center,rgba(83,52,131,0.2),transparent_70%)]" />
        <div className="absolute top-[40%] right-[20%] h-[400px] w-[400px] rounded-full bg-[radial-gradient(circle_at_center,rgba(243,156,18,0.1),transparent_70%)]" />
        <div className="absolute inset-0 bg-[url('/assets/noise.svg')] opacity-10 mix-blend-soft-light" aria-hidden="true"></div>
      </div>
