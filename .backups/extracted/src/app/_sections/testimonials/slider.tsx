...
export function VainillaCard({ quote, author }: TestimonialsSlider["quotes"][0]) {
  return (
    <div className="min-w-0 max-w-full shrink-0 grow-0 basis-[min(740px,100%)] self-stretch md:pr-10">
      <article className="embla__slide flex h-full w-full min-w-0 transform touch-pan-y touch-pinch-zoom select-none flex-col rounded-xl border border-border backface-hidden last:visible! dark:border-dark-border">
